 ...
 * POST /api/teams  { event_id, name, description, skills_wanted, track, max_members }
 */
...
export async function GET(req: NextRequest) {
  ...
  if (USE_MOCKS) {
    ...
    const data = teams.filter((t) => t.event_id === eventId || eventId === MOCK_EVENT_ID);
...
export async function POST(req: NextRequest) {
  ...
  // Guard: already on a team for this event
